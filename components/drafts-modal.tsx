    ...
    return (
        <>
            ...
            <Dialog open={open} onOpenChange={setOpen}>
                <DialogContent className="max-w-4xl w-full max-h-[85vh] h-full flex flex-col p-0 gap-0 overflow-hidden rounded-xl bg-white dark:bg-[#121212] border-neutral-200 dark:border-neutral-800">
            ...
            <Dialog open={saveDialogOpen} onOpenChange={setSaveDialogOpen}>
                <DialogContent className="sm:max-w-[425px] bg-white dark:bg-[#121212] border-neutral-200 dark:border-neutral-800">
                    <DialogHeader>
