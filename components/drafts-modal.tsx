...
export function DraftsModal({
    ...
    const handleSaveDraft = async () => {
        ...
        try {
            ...
            setDrafts(prev => {
                ...
                return [newDraft as any, ...filtered];
            });
            ...
            // Background: Actually save to IndexedDB
            saveDraft({
                id: newDraft.id,
                name: newDraft.name,
                recipients: currentRecipients,
                ...
                body: cleanBody,
                attachments: []
            }).catch(e => console.error('Background draft save failed:', e));
    ...
    const handleDeleteDraft = async (id: string, e: React.MouseEvent) => {
        ...
        try {
            ...
            // Don't revert - user already saw deletion
        }
    }
